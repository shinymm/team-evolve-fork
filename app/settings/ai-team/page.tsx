                  ...
                  <div className="flex flex-col h-full min-h-[120px]">
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-full flex items-center justify-center text-sm font-medium shadow-sm text-white bg-blue-600">
                          {app.name.charAt(0)}
                        </div>
                        <div className="font-medium leading-none mt-1">{app.name}</div>
                      </div>
                      <div className="flex items-center gap-1">
                        {app.entryUrl && (
                          <Button
                            ...
                            onClick={() => window.open(app.entryUrl, '_blank')}
                            title="访问应用"
                          >
                        ...
                        <Button
                          ...
                          className="h-7 w-7 p-0"
                          onClick={() => {
                            console.log('编辑按钮被点击:', app);
                            handleOpenApplicationDialog(app);
                          }}
                          title="编辑应用"
                        >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            console.log('删除按钮被点击:', app.id);
                            handlePrepareDeleteApplication(app.id);
                          }}
                          title="删除应用"
                        >
                    ...
                    <div className="flex-1 mt-2">
                      <p className="text-xs text-gray-600 line-clamp-4">{app.introduction}</p>
                    </div>
                    {app.category && (
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {app.category.split(/[,，]/).map((tag, index) => (
                          tag.trim() && (
                            <span 
                              key={index}
