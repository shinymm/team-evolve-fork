...
export default function AITeamApplicationsPage() {
  ...
  return (
    <div className="mx-auto py-6 w-[90%]">
      <div className="flex justify-between items-center mb-6">
        {/* Title can be more specific, e.g., t('aiTeamApplications.title') if you add it */}
        <h1 className="text-2xl font-bold">{t('tabs.applications')}</h1>
      </div>
