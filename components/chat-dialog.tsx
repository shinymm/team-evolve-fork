    ...
    <div className="fixed top-20 right-20 w-96 h-[500px] bg-background rounded-lg shadow-lg border flex flex-col z-[9999]">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b">
        <div className="flex items-center space-x-3">
          <div className={cn("w-8 h-8 rounded-full flex items-center justify-center", assistant.avatarColor)}>
            {assistant.icon}
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        <div className="flex items-start space-x-2">
          <div className={cn("w-8 h-8 rounded-full flex items-center justify-center mt-1", assistant.avatarColor)}>
            {assistant.icon}
          </div>
          <div className="bg-muted p-3 rounded-lg max-w-[80%]">
            <p>你好！我是你的日程助理，有什么可以帮你的吗？</p>
          </div>
        </div>
      </div>
